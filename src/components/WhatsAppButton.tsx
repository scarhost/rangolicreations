...
const WHATSAPP_MSG = 'Hi! I have a question about Rangoli Creations.';
...
const WhatsAppButton = () => {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-24 right-5 z-40 w-13 h-13 rounded-full flex items-center justify-center shadow-lg"
